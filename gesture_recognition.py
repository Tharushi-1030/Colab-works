...
Original file is located at
    https://colab.research.google.com/drive/13Q7X5uVrSsFAKxUnxVg40FhhgZXwpKFu
"""
...
while True:
    # Store the frame from the video capture.
    ret, frame = capture.read()

    # Check if the frame is obtained successfully.
    if not ret:
...
# When exiting the loop, release the capture and close all windows.
capture.release()
